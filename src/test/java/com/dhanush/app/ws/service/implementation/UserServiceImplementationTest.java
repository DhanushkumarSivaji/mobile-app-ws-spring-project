...
class UserServiceImplementationTest {
	...
	{
		when(userRepository.findByEmail(ArgumentMatchers.anyString())).thenReturn(null);
		when(utils.generateAddressId(ArgumentMatchers.anyInt())).thenReturn("hgfnghtyrir884");
		...
		Mockito.doNothing().when(amazonSES).verifyEmail(ArgumentMatchers.any(UserDto.class));
